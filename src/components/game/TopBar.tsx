...
// Static constants moved outside component to avoid recreation
const MONTH_NAMES = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'] as const;
const SPEED_VALUES = [0, 1, 2, 3] as const;
const SPEED_TITLES = ['Pause', 'Normal', 'Fast', 'Very Fast'] as const;

// ============================================================================
// TIME OF DAY ICON - Memoized to prevent re-renders when hour hasn't changed
// ============================================================================

// Pre-defined SVG paths to avoid recreation
