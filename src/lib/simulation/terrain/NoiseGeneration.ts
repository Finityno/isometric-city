// Perlin-like noise functions for terrain generation
...
// Smooth noise by averaging with neighbors
...
// Perlin noise using multiple octaves for natural-looking terrain
